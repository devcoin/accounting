...
def getSummaryText(earningsText, publishers, suffixNumber):
	...
	cString.write('https://raw.github.com/devcoin/accounting/master/marketing_earnings_%s.csv\n\n' % suffixNumber)
	cString.write('%s\n' % earningsText)
	...
	cString.write('https://raw.github.com/devcoin/accounting/master/marketing.py\n')
	return cString.getvalue()
